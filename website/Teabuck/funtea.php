...
<html lang="en-us">
    ...
    <body>
        ...
        ?>
        <form action="funtea.php" method="post">
            <div id="nav-container">
                ...
                <a id="nav1" href="funtea.php">Funtea</a>
                ...
                <center>
                    <div id="image-container">
                        <center>
                            <div id="content">
                                ...
                                <label>AURORA BLEND</label><br>
                                <label>Green Apple + Tea</label><br>
                                <table id="rTable">
                                    <tr>
                                        <td>M</td>
                                        <td>L</td>
                                    ...
                                    <tr>
                                        <div>
                                            <td><input value="Funtea | AURORA BLEND | Medium Php69" type="radio" name="name"></td>
                                            <td><input value="Funtea | AURORA BLEND | Large Php89" type="radio" name="name"></td>
                                            <script>
                    ...
                    <div id="image-container">
                        <center>
                            <div id="content">
                                <img src="image/pic.png" id="image-content">
                                <label>MERRY DANCERS</label><br>
                                <label>Lychee + Tea</label><br>
                                <table id="rTable">
                                    <tr>
                                        <td>M</td>
                                        <td>L</td>
                                    ...
                                    <tr>
                                        <div>
                                            <td><input value="Funtea | MERRY DANCERS | Medium Php69" type="radio" name="name1"></td>
                                            <td><input value="Funtea | MERRY DANCERS | Large Php89" type="radio" name="name1"></td>
                                            <script>
                                                var radios = document.getElementsByTagName('input');
                                                for(i=0; i<radios.length; i++){
                                                    radios[i].onclick = function(e){
                    ...
                    <div id="image-container">
                        <center>
                            <div id="content">
                                <img src="image/pic.png" id="image-content">
                                <label>POLAR LIGHTS</label><br>
                                <label>Kiwi + Tea</label><br>
                                <table id="rTable">
                                    <tr>
                                        <td>M</td>
                                        <td>L</td>
                                    ...
                                    <tr>
                                        <div>
                                            <td><input value="Funtea | POLAR LIGHTS | Medium Php69" type="radio" name="name2"></td>
                                            <td><input value="Funtea | POLAR LIGHTS | Large Php89" type="radio" name="name2"></td>
                                            <script>
                                                var radios = document.getElementsByTagName('input');
                                                for(i=0; i<radios.length; i++){
                                                    radios[i].onclick = function(e){
                    ...
                    <div id="image-container">
                        <center>
                            <div id="content">
                                <img src="image/pic.png" id="image-content">
                                <label>MORNING DAWN</label><br>
                                <label>Mango + Tea</label><br>
                                <table id="rTable">
                                    <tr>
                                        <td>M</td>
                                        <td>L</td>
                                    ...
                                    <tr>
                                        <div>
                                            <td><input value="Funtea | MORNING DAWN | Medium Php69" type="radio" name="name3"></td>
                                            <td><input value="Funtea | MORNING DAWN | Large Php89" type="radio" name="name3"></td>
                                            <script>
                                                var radios = document.getElementsByTagName('input');
                                                for(i=0; i<radios.length; i++){
                                                    radios[i].onclick = function(e){
                    ...
                    <div id="image-container">
                        <center>
                            <div id="content">
                                <img src="image/pic.png" id="image-content">
                                <label>ECLIPSE</label><br>
                                <label>Grapes + Tea</label><br>
                                <table id="rTable">
                                    <tr>
                                        <td>M</td>
                                        <td>L</td>
                                    ...
                                    <tr>
                                        <div>
                                            <td><input value="Funtea | ECLIPSE | Medium Php69" type="radio" name="name4"></td>
                                            <td><input value="Funtea | ECLIPSE | Large Php89" type="radio" name="name4"></td>
                                            <script>
                                                var radios = document.getElementsByTagName('input');
                                                for(i=0; i<radios.length; i++){
                                                    radios[i].onclick = function(e){
